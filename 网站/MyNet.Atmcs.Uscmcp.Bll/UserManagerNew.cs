...
namespace MyNet.Atmcs.Uscmcp.Bll
{
    ...
    {
        private SystemManagerNew systemManager = new SystemManagerNew();
        private SettingManagerNew settingManager = new SettingManagerNew();

        /// <summary>
        ///  用户操作接口
        /// </summary>
        private static readonly IUserManagerNew dal = DALFactory.CreateUserManagerNew();
        /// <summary>
        /// 获得用户具有系统
        /// </summary>
