...
namespace MyNet.Atmcs.Uscmcp.Bll
{
    public class GetIPAdddress
    {
        ...
        public GetIPAdddress(string ipfile)
        {
            buf = new byte[100];
            b3 = new byte[3];
            b4 = new byte[4];
