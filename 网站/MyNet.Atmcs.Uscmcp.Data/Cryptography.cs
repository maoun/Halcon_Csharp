...
namespace MyNet.Atmcs.Uscmcp.Data
{
    public class Cryptography
    {
        ...
        public static string Encrypt(string originString)
        {
            ...
            sbyte[] originByteArray = ToSByteArray(ToByteArray(originString));
        ...
        {
            sbyte[] fullString = ToSByteArray(ToByteArray(encryptedString));
        ...
        public static int randomNum(int min, int max)
        {
            ...
            else
            {
                ...
                int result = (int)(range * (Random.NextDouble()) + min);
                return result;
            }
        }
