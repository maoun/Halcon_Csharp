<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebLineChart.aspx.cs" Inherits="MyNet.Atmcs.Uscmcp.Web.WebLineChart" %>
                    ...
                    series: [
                        {
                            ...
                            itemStyle: { normal: { areaStyle: { color: '#78c9ec', type: 'default' }, lineStyle: { borderColor: "green", color: '#000', type: 'type', width: '1' }, label: { show: true, textStyle: { color: '#3a535b' } } } },
