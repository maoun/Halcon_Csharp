...
{
    public partial class PeccancyCheck : System.Web.UI.Page
    {
        #region 成员变量
        ...
        {
            string username = Request.QueryString["username"]; if (!userLogin.CheckLogin(username)) { string js = "alert('"+GetLangStr("PeccancyQuery44", "您没有登录或操作超时，请重新登录!")+"');window.top.location.href='" + StaticInfo.LoginPage + "'"; System.Web.HttpContext.Current.Response.Write("<script type='text/javascript'>" + js + "</script>"); return; }
            if (!X.IsAjaxRequest)
            {
                try
                {
                ...
                catch (Exception ex)
                {
                    ...
                    logManager.InsertLogError("PeccancyCheck.aspx-Page_Load", ex.Message + "；" + ex.StackTrace, "Page_Load has an exception");
                }
                UserInfo userinfo = Session["Userinfo"] as UserInfo;
                logManager.InsertLogRunning(userinfo.UserName, GetLangStr("PeccancyQuery50","访问：") + Request.QueryString["funcname"], userinfo.NowIp, "0");
            }
            this.DataBind();
        }
        ...
        protected void TbutQueryClick(object sender, DirectEventArgs e)
        {
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-TbutQueryClick", ex.Message + "；" + ex.StackTrace, "TbutQueryClick has an exception");
            }
        }
        ...
        protected void TbutFisrt(object sender, DirectEventArgs e)
        {
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-TbutFisrt", ex.Message + "；" + ex.StackTrace, "TbutFisrt has an exception");
            }
        }
        ...
        protected void TbutLast(object sender, DirectEventArgs e)
        {
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-TbutLast", ex.Message + "；" + ex.StackTrace, "TbutLast has an exception");
            }
        }
        ...
        protected void TbutNext(object sender, DirectEventArgs e)
        {
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-TbutNext", ex.Message + "；" + ex.StackTrace, "TbutNext has an exception");
            }
        }
        ...
        protected void TbutEnd(object sender, DirectEventArgs e)
        {
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-TbutEnd", ex.Message + "；" + ex.StackTrace, "TbutEnd has an exception");
            }
        }
        ...
        protected void TgsRefresh(object sender, StoreRefreshDataEventArgs e)
        {
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-TgsRefresh", ex.Message + "；" + ex.StackTrace, "TgsRefresh has an exception");
            }
        }
        ...
        protected void ShowDetails(object sender, DirectEventArgs e)
        {
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-ShowDetails", ex.Message + "；" + ex.StackTrace, "ShowDetails has an exception");
            }
        }
        ...
        protected void ApplyClick(object sender, DirectEventArgs e)
        {
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-ApplyClick", ex.Message + "；" + ex.StackTrace, "ApplyClick has an exception");
            }
        }
        ...
        protected void ButCheckClick(object sender, DirectEventArgs e)
        {
            try
            {
                string js = "OpenCheckModelPage();";
                this.ResourceManager1.RegisterAfterClientInitScript(js);
            }
            catch (Exception ex)
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-ButCheckClick", ex.Message + "；" + ex.StackTrace, "ButCheckClick has an exception");
            }
        }
        ...
        public void GetDateTime(bool isstart, string strtime)
        {
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-GetDateTime", ex.Message + "；" + ex.StackTrace, "GetDateTime has an exception");
            }
        }
        ...
        public DataTable ToDataTable(DataRow[] rows)
        {
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-ToDataTable", ex.Message + "；" + ex.StackTrace, "ToDataTable has an exception");
            }
            return null;
        }
        ...
        private void StoreDataBind()
        {
            try
            {
                ...
                {
                    DataTable dt = tgsPproperty.GetProcessType();
                    dt.Rows.RemoveAt(3);
                    dt.Rows.RemoveAt(3);
                    this.StoreDealType.DataSource = dt;
                    this.StoreDealType.DataBind();
                }
                //DataTable deal = GetRedisData.GetData("t_sys_code:240019"); // tgsPproperty.GetProcessType();
                //deal.Rows.RemoveAt(3);
                //deal.Rows.RemoveAt(3);
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-StoreDataBind", ex.Message + "；" + ex.StackTrace, "StoreDataBind has an exception");
            }
        }
        ...
        private void DataSetDateTime()
        {
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-DataSetDateTime", ex.Message + "；" + ex.StackTrace, "DataSetDateTime has an exception");
            }
        }
        ...
        private void GetData()
        {
            try
            {
                ...
                //    this.lblAllpage.Text = "0";
                //    this.lblRealcount.Text = "0";
                //    Notice(GetLangStr("PeccancyCheck37", "信息提示"), GetLangStr("PeccancyCheck38", "未查询到符合条件的任何记录！"));
                //}
            }
            catch (Exception ex)
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-GetData", ex.Message + "；" + ex.StackTrace, "GetData has an exception");
            }
        }
        ...
        private void ShowQuery(int currentPage)
        {
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-ShowQuery", ex.Message + "；" + ex.StackTrace, "ShowQuery has an exception");
            }
        }
        ...
        private void Query(string where, int startNum, int endNum)
        {
            try
            {
                ...
                else
                {
                    ...
                    this.lblAllpage.Text = "0";
                    this.lblRealcount.Text = "0";
                    Notice(GetLangStr("PeccancyQuery50", "信息提示"),GetLangStr("PeccancyQuery51", "未查询到相关记录"));
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-Query", ex.Message + "；" + ex.StackTrace, "Query has an exception");
            }
        }
        ...
        private void SetButState(int page)
        {
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-SetButState", ex.Message + "；" + ex.StackTrace, "SetButState has an exception");
            }
        }
        ...
        private string GetWhere()
        {
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-GetWhere", ex.Message + "；" + ex.StackTrace, "GetWhere has an exception");
                return "";
            }
        }
        ...
        private string GetUrl(DataTable dt, string idx)
        {
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-GetUrl", ex.Message + "；" + ex.StackTrace, "GetUrl has an exception");
                return "";
            }
        }
        ...
        private void Notice(string title, string msg)
        {
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-Notice", ex.Message + "；" + ex.StackTrace, "Notice has an exception");
            }
        }
        ...
        public string ConvertCondition(bool isALL, string xzjb, string jgjb, string depcode)
        {
            ...
            {
                ILog.WriteErrorLog(ex);
                logManager.InsertLogError("PeccancyCheck.aspx-ConvertCondition", ex.Message + "；" + ex.StackTrace, "ConvertCondition has an exception");
                return "";
            }
        }
