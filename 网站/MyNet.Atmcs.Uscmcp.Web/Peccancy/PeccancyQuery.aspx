<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PeccancyQuery.aspx.cs" Inherits="MyNet.Atmcs.Uscmcp.Web.PeccancyQuery" %>
        ...
        <ext:Viewport ID="Viewport2" runat="server" Layout="border">
            <Items>
                            ...
                            <Items>
                                <ext:Toolbar ID="Toolbar1" runat="server" Height="40">
                                    <Items>
                                        <ext:Panel runat="server" BodyBorder="false">
                                            <Content>
                                                <div runat="server" id="selectDate" style="width: 475px">
                                                    <span class="laydate-span" style="height: 24px; margin-left: 10px;"><%# GetLangStr("PeccancyQuery1","查询时间：")%></span>
                                                    <li runat="server" class="laydate-icon" id="start" style="width: 153px; height: 22px; margin-left: 0px;"></li>
                                                </div>
                                                <div>
                                                    <span class="laydate-span" style="height: 24px; margin-left: 10px;">--</span>
                                                    <li runat="server" class="laydate-icon" id="end" style="width: 153px; height: 22px; margin-left: 20px;"></li>
                                                </div>
                                            </Content>
                                        </ext:Panel>
                                        <ext:Label ID="Label1" runat="server" Text='<%# GetLangStr("PeccancyQuery3","号牌种类：") %>' StyleSpec="margin-left: 10px;">
                                        </ext:Label>
                                        <ext:ComboBox ID="CmbPlateType" runat="server" Editable="false" DisplayField="col1"
                                            ValueField="col0" TypeAhead="true" Mode="Local" ForceSelection="true" EmptyText='<%# GetLangStr("PeccancyQuery4","请选择...")%>'
                                            SelectOnFocus="true" Width="150">
                                            <Triggers>
                                                <ext:FieldTrigger Icon="Clear" HideTrigger="true" Qtip='<%# GetLangStr("PeccancyQuery61","清除选中：") %>' AutoDataBind="true" />
                                            </Triggers>
                                            <Listeners>
                                        ...
                                        <ext:Label ID="Label3" runat="server" Text='<%# GetLangStr("PeccancyQuery2","号牌号码：") %>' StyleSpec="margin-left: 10px; ">
                                        </ext:Label>
                                        ...
                                        <ext:Panel runat="server" Layout="ColumnLayout" Height="30">
                                            <Items>
                                                <ext:TextField runat="server" Width="150" ID="TxtplateId" EmptyText='<%# GetLangStr("PeccancyQuery36","六位号牌号码") %>' MaxLength="6">
                                                    <Listeners>
                                ...
                                <ext:Toolbar ID="Toolbar6" runat="server" Flat="false" Height="40">
                                    <Items>
                                        <ext:Label ID="Label5" runat="server" Text='<%# GetLangStr("PeccancyQuery6","违法行为：") %>' StyleSpec="margin-left: 10px;">
                                        </ext:Label>
                                        <ext:ComboBox ID="CmbPecType" runat="server" Editable="false" DisplayField="col2"
                                            ValueField="col1" TypeAhead="true" Mode="Local" ForceSelection="true" EmptyText='<%# GetLangStr("PeccancyQuery7","选择违法行为...")%>'
                                        ...
                                        <ext:Label ID="Label7" runat="server" Text='<%# GetLangStr("PeccancyQuery8","数据来源：") %>' StyleSpec="margin-left: 10px;">
                                        </ext:Label>
                                        <ext:ComboBox ID="CmbDataSource" runat="server" Editable="false" DisplayField="col1"
                                            ValueField="col0" TypeAhead="true" Mode="Local" ForceSelection="true" EmptyText='<%# GetLangStr("PeccancyQuery9","选择数据来源...")%>'
                                            SelectOnFocus="true" Width="150">
                                            <Triggers>
                                                <ext:FieldTrigger Icon="Clear" HideTrigger="true" Qtip='<%# GetLangStr("PeccancyQuery61","清除选中：") %>' AutoDataBind="true" />
                                            </Triggers>
                                        ...
                                        <ext:Label ID="Label8" runat="server" Text='<%# GetLangStr("PeccancyQuery10","所属机构：") %>' StyleSpec="margin-left: 10px;">
                                        </ext:Label>
                                ...
                                <ext:Toolbar ID="Toolbar3" runat="server" Flat="false" Height="40">
                                    <Items>
                                        <ext:Label ID="Label4" runat="server" Text='<%# GetLangStr("PeccancyQuery11","违法地点：") %>' StyleSpec="margin-left: 10px;">
                                        </ext:Label>
                                        <ext:MultiCombo ID="CmbLocation" runat="server" Editable="false" DisplayField="col2"
                                            Width="390" ValueField="col1" TypeAhead="true" Mode="Local" ForceSelection="true"
                                            ListWidth="390" EmptyText='<%# GetLangStr("PeccancyQuery12","选择违法地点...")%>' SelectOnFocus="true" SelectionMode="Checkbox">
                                            <Store>
                                            ...
                                            <Listeners>
                                                <Select Handler="#{CmbDirection}.clearValue(); #{StoreDirection}.reload();" />
                                            </Listeners>
                                        </ext:MultiCombo>
                                        <ext:Label ID="Label10" runat="server" Text='<%# GetLangStr("PeccancyQuery13","行驶方向：") %>' StyleSpec="margin-left: 10px;">
                                        </ext:Label>
                                        <ext:ComboBox ID="CmbDirection" runat="server" Editable="false" DisplayField="col1"
                                            ValueField="col0" TypeAhead="true" Mode="Local" ForceSelection="true" EmptyText='<%# GetLangStr("PeccancyQuery14","选择行驶方向...")%>'
                                            ...
                                            <Store>
                                                <ext:Store ID="StoreDirection" runat="server" AutoLoad="false" OnRefreshData="TgsRefresh">
                                        ...
                                        <ext:Label ID="Label6" runat="server" Text='<%# GetLangStr("PeccancyQuery15","处理状态：") %>' StyleSpec="margin-left: 10px;">
                                        </ext:Label>
                                        <ext:ComboBox ID="CmbDealType" runat="server" Editable="false" DisplayField="col1"
                                            ValueField="col0" TypeAhead="true" Mode="Local" ForceSelection="true" EmptyText='<%# GetLangStr("PeccancyQuery16","选择处理状态...")%>'
                                            SelectOnFocus="true" Width="110">
                                            <Triggers>
                                                <ext:FieldTrigger Icon="Clear" HideTrigger="true" Qtip='<%# GetLangStr("PeccancyQuery59","清除选中") %>' AutoDataBind="true" />
                                            </Triggers>
                                            <Listeners>
                                                <Select Handler="this.triggers[0].show();" />
                                                <BeforeQuery Handler="this.triggers[0][ this.getRawValue().toString().length == 0 ? 'hide' : 'show']();" />
                                        ...
                                        <ext:Button ID="TbutQuery" runat="server" Icon="ControlPlayBlue" Text='<%# GetLangStr("PeccancyQuery19","查询")%>'>
                                            <DirectEvents>
                                        ...
                                        <ext:Button ID="ButReset" runat="server" Icon="ControlBlank" Text='<%# GetLangStr("PeccancyQuery20","重置")%>'>
                                            <DirectEvents>
                            ...
                            <Items>
                                <ext:Toolbar runat="server">
                                    <Items>
                                        ...
                                        <ext:Button ID="ButFisrt" runat="server" StyleSpec="margin-left:10px;" Text='<%# GetLangStr("PeccancyQuery22","首页")%>' Disabled="true">
                                            <DirectEvents>
                                                <Click OnEvent="TbutFisrt" />
                                            </DirectEvents>
                                        </ext:Button>
                                        <ext:Button ID="ButLast" runat="server" Icon="ControlRewindBlue" StyleSpec="margin-left:10px;" Text='<%# GetLangStr("PeccancyQuery23","上一页")%>' Disabled="true">
                                            <DirectEvents>
                                                <Click OnEvent="TbutLast" />
                                            </DirectEvents>
                                        </ext:Button>
                                        <ext:Button ID="ButNext" runat="server" Icon="ControlFastforwardBlue" StyleSpec="margin-left:10px;" Text='<%# GetLangStr("PeccancyQuery24","下一页")%>'
                                            Disabled="true">
                                            <DirectEvents>
                                                <Click OnEvent="TbutNext" />
                                            </DirectEvents>
                                        </ext:Button>
                                        <ext:Button ID="ButEnd" runat="server" StyleSpec="margin-left:10px;" Text='<%# GetLangStr("PeccancyQuery25","尾页")%>' Disabled="true">
                                            <DirectEvents>
                                                <Click OnEvent="TbutEnd" />
                                            </DirectEvents>
                                        </ext:Button>

                                        <ext:Label ID="lblTitle" runat="server" Text='<%# GetLangStr("PeccancyQuery55","查询结果：当前是第")%>' StyleSpec="margin-left:10px;" />
                                        <ext:Label ID="lblCurpage" runat="server" Text="" Cls="pageNumLabel" />
                                        <ext:Label ID="Label2" runat="server" Text='<%# GetLangStr("PeccancyQuery56","页,共有")%>' />
                                        <ext:Label ID="lblAllpage" runat="server" Text="" Cls="pageNumLabel" />
                                        <ext:Label ID="Label9" runat="server" Text='<%# GetLangStr("PeccancyQuery56","页,共有")%>'/>
                                        <ext:Label ID="lblRealcount" runat="server" Text="" Cls="pageNumLabel" />
                                        <ext:Label ID="Label12" runat="server" Text='<%# GetLangStr("PeccancyQuery58","条记录")%>' />
                                        <ext:ToolbarFill></ext:ToolbarFill>
                                        <ext:Button ID="ButExcel" runat="server" Text='<%# GetLangStr("PeccancyQuery28","导出Excel")%>' AutoPostBack="true" OnClick="ToExcel"
                                            Icon="PageExcel">
                                        </ext:Button>
                                    </Items>
                                </ext:Toolbar>
                        ...
                        <ext:GridPanel ID="GridPanel1" runat="server" StripeRows="true" Header="false" BodyStyle="height:100%;width:100%" Collapsible="true"
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ColumnID="Details" Header='<%# GetLangStr("PeccancyQuery31","详细")%>' AutoDataBind="true" Width="40" Align="Center" Fixed="true"
                                        MenuDisabled="true" Resizable="false">
                                        <Renderer Fn="DataAmply" />
                                    </ext:Column>
                                    <ext:Column ColumnID="Video" Header='<%# GetLangStr("PeccancyQuery32","视频")%>' AutoDataBind="true" Width="40" DataIndex="col26" Hidden="true">
                                        <Renderer Fn="VideoAmply" />
                                        <Commands>
                                            <ext:ImageCommand CommandName="VideShow" Icon="Television" Text="">
                                                <ToolTip Text='<%# GetLangStr("PeccancyQuery32","视频")%>' AutoDataBind="true" />
                                            </ext:ImageCommand>
                                        </Commands>
                                        <PrepareCommand Fn="prepare" />
                                    </ext:Column>
                                    <ext:Column Header='<%# GetLangStr("PeccancyQuery34","记录编号")%>' AutoDataBind="true" Width="80" Sortable="true" DataIndex="col0" Hidden="true" />
                                    <ext:Column Header='<%# GetLangStr("PeccancyQuery35","违法地点")%>' AutoDataBind="true" Width="120" Sortable="true" DataIndex="col8" Align="Left">
                                    </ext:Column>
                                    <ext:Column Header='<%# GetLangStr("PeccancyQuery36","号牌号码")%>' AutoDataBind="true" Width="80" Sortable="true" DataIndex="col3" Align="Center">
                                    </ext:Column>
                                    <ext:Column Header='<%# GetLangStr("PeccancyQuery37", "号牌种类")%>' AutoDataBind="true" Width="100" Sortable="true" DataIndex="col2" Align="Center">
                                    </ext:Column>
                                    <ext:DateColumn Header='<%# GetLangStr("PeccancyQuery38","违法时间" )%>' AutoDataBind="true" DataIndex="col6" Width="140" Format="yyyy-MM-dd HH:mm:ss" Align="Center" />
                                    <ext:Column Header='<%# GetLangStr("PeccancyQuery39","违法行为")%>' AutoDataBind="true" Width="150" Sortable="true" DataIndex="col5" Align="Left">
                                    </ext:Column>
                                    <ext:Column Header='<%# GetLangStr("PeccancyQuery40","行驶方向")%>' AutoDataBind="true" Width="100" Sortable="true" DataIndex="col11" Align="Center">
                                    </ext:Column>
                                    <ext:Column Header='<%# GetLangStr("PeccancyQuery41","速度限速")%>' AutoDataBind="true" Width="80" Sortable="true" DataIndex="col12" Align="Center">
                                    </ext:Column>
                                    <ext:Column Header='<%# GetLangStr("PeccancyQuery42","处理状态")%>' AutoDataBind="true" Width="100" Sortable="true" DataIndex="col20" Align="Center">
                                    </ext:Column>
                                    <ext:Column Header='<%# GetLangStr("PeccancyQuery43", "所属机构")%>' AutoDataBind="true" Width="160" Sortable="true" DataIndex="col14" Align="Center">
                                    </ext:Column>
                                </Columns>
                            </ColumnModel>
                            <SelectionModel>
                ...
                <ext:FormPanel ID="FormPanel1" runat="server" Region="East" Split="true" Frame="true"
                    Title='<%# GetLangStr("PeccancyQuery44","详细信息")%>' Width="0" Height="0" Icon="Images" DefaultAnchor="100%" Collapsible="true"
                    AutoScroll="true" Collapsed="true">
                    <Content>
                        <div class="photoblock-many">
                            <center>
                                <div id="divplateId" style="width: 100%; font-size: 30pt; font-family: '<%# GetLangStr("PeccancyCheck62","微软雅黑")%>' ; color: white; background-color: blue;">
                                </div>
                                <div class="container" style="width: 100%; height: 220px">
                                    <div class="fis">
                                        <img id="zjwj1" style="cursor: pointer" onclick="$.openPhotoGallery(this);" class="photo"
                                            src="../images/NoImage.png" alt="+'<%# GetLangStr("PeccancyQuery59", "车辆图片(图片点击滚轮缩放)")%>'+" width="100%" height="220" />
                                    </div>
