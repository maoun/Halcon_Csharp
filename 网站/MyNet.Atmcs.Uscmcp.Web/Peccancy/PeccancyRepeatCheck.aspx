<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PeccancyRepeatCheck.aspx.cs"
    Inherits="MyNet.Atmcs.Uscmcp.Web.PeccancyRepeatCheck" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:ResourceManager ID="ResourceManager1" runat="server" DirectMethodNamespace="PeccancyRepeatCheck" />
        ...
        <ext:Viewport ID="Viewport2" runat="server" Layout="border">
            <Items>
                            ...
                            <Items>
                                <ext:Toolbar ID="Toolbar1" runat="server">
                                    <Items>
                                        <ext:Panel runat="server" BodyBorder="false">
                                            <Content>
                                                <div runat="server" id="selectDate" style="width: 475px">
                                                    <span class="laydate-span" style="margin-left: 0px; height: 24px;">&nbsp;&nbsp;<%# GetLangStr("PeccancyRepeatCheck1","查询时间：") %></span>
                                        ...
                                        <ext:Label ID="Label1" runat="server" Text='<%# GetLangStr("PeccancyRepeatCheck3","号牌种类：") %>' StyleSpec="margin-left: 10px;">
                                        </ext:Label>
                                        <ext:ComboBox ID="CmbPlateType" runat="server" Editable="false" DisplayField="col1"
                                            ValueField="col0" TypeAhead="true" Mode="Local" ForceSelection="true" EmptyText='<%# GetLangStr("PeccancyRepeatCheck4","请选择...")%>'
                                            SelectOnFocus="true" Width="150">
                                            <Triggers>
                                                <ext:FieldTrigger Icon="Clear" HideTrigger="true" Qtip='<%# GetLangStr("PeccancyQuery39","清除选中：") %>' AutoDataBind="true" />
                                            </Triggers>
                                            <Listeners>
                                        ...
                                        <ext:Label ID="Label3" runat="server" Text='<%# GetLangStr("PeccancyRepeatCheck2","号牌号码：") %>' StyleSpec="margin-left: 10px; ">
                                        </ext:Label>
                                        ...
                                        <ext:Panel runat="server" Layout="ColumnLayout" Height="30">
                                            <Items>
                                                <ext:TextField runat="server" Width="150" ID="TxtplateId" EmptyText='<%# GetLangStr("PeccancyRepeatCheck40","号牌号码：") %>' MaxLength="6">
                                                    <Listeners>
                                        ...
                                        <ext:Panel runat="server">
                                            <Items>
                                                ...
                                                <ext:Checkbox ID="ChkLike" Checked="false" runat="server" BoxLabel='<%# GetLangStr("PeccancyQuery5","模糊查询")%>' StyleSpec="margin-left:4px;">
                                                    <DirectEvents>
                                ...
                                <ext:Toolbar ID="Toolbar6" runat="server" Flat="false">
                                    <Items>
                                        <ext:Label ID="Label5" runat="server" Text='<%# GetLangStr("PeccancyRepeatCheck6","违法行为：") %>' StyleSpec="margin-left: 10px;">
                                        </ext:Label>
                                        <ext:ComboBox ID="CmbPecType" runat="server" Editable="false" DisplayField="col2"
                                            ValueField="col1" TypeAhead="true" Mode="Local" ForceSelection="true" EmptyText='<%# GetLangStr("PeccancyRepeatCheck7","选择违法行为...")%>'
                                        ...
                                        <ext:Label ID="Label7" runat="server" Text='<%# GetLangStr("PeccancyRepeatCheck8","数据来源：") %>' StyleSpec="margin-left: 10px;">
                                        </ext:Label>
                                        <ext:ComboBox ID="CmbDataSource" runat="server" Editable="false" DisplayField="col1"
                                            ValueField="col0" TypeAhead="true" Mode="Local" ForceSelection="true" EmptyText='<%# GetLangStr("PeccancyRepeatCheck9","选择数据来源...")%>'
                                            SelectOnFocus="true" Width="150">
                                            <Triggers>
                                                <ext:FieldTrigger Icon="Clear" HideTrigger="true" Qtip='<%# GetLangStr("PeccancyQuery39","清除选中：") %>' AutoDataBind="true" />
                                            </Triggers>
                                        ...
                                        <ext:Label ID="Label8" runat="server" Text='<%# GetLangStr("PeccancyRepeatCheck10","所属机构：") %>' StyleSpec="margin-left: 10px;">
                                        </ext:Label>
                                ...
                                <ext:Toolbar runat="server">
                                    <Items>
                                        <ext:Label ID="Label4" runat="server" Text='<%# GetLangStr("PeccancyRepeatCheck11","违法地点：") %>' StyleSpec="margin-left: 10px;">
                                        </ext:Label>
                                        <ext:ComboBox ID="CmbLocation" runat="server" Editable="false" DisplayField="col2"
                                            ...
                                            ListWidth="390" EmptyText='<%# GetLangStr("PeccancyRepeatCheck12","选择违法地点...")%>' SelectOnFocus="true">
                                            <Triggers>
                                                <ext:FieldTrigger Icon="Clear" HideTrigger="true" Qtip='<%# GetLangStr("PeccancyQuery39","清除选中：") %>' AutoDataBind="true" />
                                            </Triggers>
                                            <Listeners>
                                        ...
                                        <ext:Label ID="Label10" runat="server" Text='<%# GetLangStr("PeccancyRepeatCheck13","行驶方向：") %>' StyleSpec="margin-left: 10px;">
                                        </ext:Label>
                                        <ext:ComboBox ID="CmbDirection" runat="server" Editable="false" DisplayField="col1"
                                            ValueField="col0" TypeAhead="true" Mode="Local" ForceSelection="true" EmptyText='<%# GetLangStr("PeccancyRepeatCheck14","选择行驶方向...")%>'
                                        ...
                                        <ext:Label ID="Label6" runat="server" Text='<%# GetLangStr("PeccancyRepeatCheck15","处理状态：") %>' StyleSpec="margin-left: 10px;">
                                        </ext:Label>
                                        <ext:ComboBox ID="CmbDealType" runat="server" Editable="false" DisplayField="col1"
                                            ValueField="col0" TypeAhead="true" Mode="Local" ForceSelection="true" EmptyText='<%# GetLangStr("PeccancyRepeatCheck16","选择处理状态...")%>'
                                        ...
                                        <ext:Label ID="Label9" runat="server" Text='<%# GetLangStr("PeccancyRepeatCheck17","提取条数：") %>' StyleSpec="margin-left: 5px; ">
                                        </ext:Label>
                                        <ext:ComboBox ID="CmbQueryNum" runat="server" Editable="false" DisplayField="col1"
                                            ...
                                            EmptyText='<%# GetLangStr("PeccancyRepeatCheck18","选择...")%>' SelectOnFocus="true">
                                        ...
                                        <ext:Button ID="TbutQuery" runat="server" Icon="ControlPlayBlue" Text='<%# GetLangStr("PeccancyRepeatCheck19","查询")%>'>
                                            <DirectEvents>
                                        ...
                                        <ext:Button ID="ButReset" runat="server" Icon="ControlBlank" Text='<%# GetLangStr("PeccancyRepeatCheck20","重置")%>'>
                                            <DirectEvents>
                ...
                <ext:FormPanel ID="FormPanel2" Region="Center" runat="server" Layout="FitLayout"
                    AutoScroll="true">
                    <TopBar>
                        <ext:Toolbar runat="server" ID="ToolExport" Layout="ContainerLayout">
                            <Items>
                                    ...
                                    <Items>
                                        <ext:Toolbar runat="server">
                                            <Items>
                                                ...
                                                <ext:Button ID="ButFisrt" runat="server" Text='<%# GetLangStr("PeccancyQuery40","首页")%>' Disabled="true" Hidden="true">
                                                    <DirectEvents>
                                                        <Click OnEvent="TbutFisrt" />
                                                    </DirectEvents>
                                                </ext:Button>
                                                <ext:Button ID="ButLast" runat="server" StyleSpec="margin-left:10px;" Icon="ControlRewindBlue" Text='<%# GetLangStr("PeccancyQuery41","上一页")%>' Disabled="true" Hidden="true">
                                                    <DirectEvents>
                                                        <Click OnEvent="TbutLast" />
                                                    </DirectEvents>
                                                </ext:Button>
                                                <ext:Button ID="ButNext" runat="server" StyleSpec="margin-left:10px;" Icon="ControlFastforwardBlue" Text='<%# GetLangStr("PeccancyQuery42","下一页")%>' Hidden="true"
                                                    Disabled="true">
                                                    <DirectEvents>
                                                        <Click OnEvent="TbutNext" />
                                                    </DirectEvents>
                                                </ext:Button>
                                                <ext:Button ID="ButEnd" runat="server" StyleSpec="margin-left:10px;" Text='<%# GetLangStr("PeccancyQuery43","尾页")%>' Disabled="true" Hidden="true">
                                                    <DirectEvents>
                                                        <Click OnEvent="TbutEnd" />
                                                    </DirectEvents>
                                                </ext:Button>
                                                <ext:Label ID="lblTitle" runat="server" Text='<%# GetLangStr("PeccancyQuery44","查询结果：当前是第")%>' StyleSpec="margin-left:10px;" />
                                                <ext:Label ID="lblCurpage" runat="server" Text="" Cls="pageNumLabel" />
                                                <ext:Label ID="Label2" runat="server" Text='<%# GetLangStr("PeccancyQuery45","页,共有")%>' />
                                                <ext:Label ID="lblAllpage" runat="server" Text="" Cls="pageNumLabel" />
                                                <ext:Label ID="Label11" runat="server" Text='<%# GetLangStr("PeccancyQuery45","页,共有")%>' StyleSpec="font-weight:bolder;" />
                                                <ext:Label ID="lblRealcount" runat="server" Text="" Cls="pageNumLabel" />
                                                <ext:Label ID="Label12" runat="server" Text='<%# GetLangStr("PeccancyQuery46","条记录")%>' />

                                                <ext:ToolbarFill ID="ToolbarFill1" runat="server" />
                                                <ext:Button ID="ButCheck" runat="server" Icon="TableSave" Text='<%# GetLangStr("PeccancyRepeatCheck22","开始审核")%>'>
                                                    <DirectEvents>
                    ...
                    <Items>
                        <ext:GridPanel ID="GridPanel1" runat="server" StripeRows="true" Header="false" TrackMouseOver="true">
                            <Store>
                                <ext:Store ID="StorePeccancy" runat="server">

                                    <UpdateProxy>
                                        <ext:HttpWriteProxy Method="GET" Url="PeccancyRepeatCheck.aspx">
                                        </ext:HttpWriteProxy>
                                    </UpdateProxy>
                                    <Reader>
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ColumnID="Details" Header='<%# GetLangStr("PeccancyRepeatCheck23","详细")%>' AutoDataBind="true" Width="50" Align="Center" Fixed="true"
                                        MenuDisabled="true" Resizable="false">
                                        <Renderer Fn="DataAmply" />
                                    </ext:Column>
                                    <ext:Column ColumnID="Video" Header='<%# GetLangStr("PeccancyRepeatCheck24","视频")%>' AutoDataBind="true" Width="40" DataIndex="col26" Hidden="true">
                                        <Renderer Fn="VideoAmply" />
                                        <Commands>
                                            <ext:ImageCommand CommandName="VideShow" Icon="Television" Text="">
                                                <ToolTip Text='<%# GetLangStr("PeccancyRepeatCheck24","视频")%>' AutoDataBind="true" />
                                            </ext:ImageCommand>
                                        </Commands>
                                        <PrepareCommand Fn="prepare" />
                                    </ext:Column>
                                    <ext:Column Header='<%# GetLangStr("PeccancyRepeatCheck26","记录编号")%>' AutoDataBind="true" Width="80" Sortable="true" DataIndex="col0" Hidden="true" />
                                    <ext:Column Header='<%# GetLangStr("PeccancyRepeatCheck27","违法地点")%>' AutoDataBind="true" Width="120" Sortable="true" DataIndex="col8" Align="Left">
                                    </ext:Column>
                                    <ext:Column Header='<%# GetLangStr("PeccancyRepeatCheck35","号牌号码")%>' AutoDataBind="true" Width="75" Sortable="true" DataIndex="col3" Align="Center">
                                    </ext:Column>
                                    <ext:Column Header='<%# GetLangStr("PeccancyRepeatCheck28", "号牌种类")%>' AutoDataBind="true" Width="100" Sortable="true" DataIndex="col2" Align="Center">
                                    </ext:Column>
                                    <ext:DateColumn Header='<%# GetLangStr("PeccancyRepeatCheck29","违法时间")%>' AutoDataBind="true" DataIndex="col6" Width="120" Format="yyyy-MM-dd HH:mm:ss" Align="Center" />
                                    <ext:Column Header='<%# GetLangStr("PeccancyRepeatCheck30","违法行为")%>' AutoDataBind="true" Width="150" Sortable="true" DataIndex="col5" Align="Left">
                                    </ext:Column>
                                    <ext:Column Header='<%# GetLangStr("PeccancyRepeatCheck31","行驶方向")%>' AutoDataBind="true" Width="100" Sortable="true" DataIndex="col11" Align="Center">
                                    </ext:Column>
                                    <ext:Column Header='<%# GetLangStr("PeccancyRepeatCheck32","速度/限速")%>' AutoDataBind="true" Width="80" Sortable="true" DataIndex="col12" Align="Center">
                                    </ext:Column>
                                    <ext:Column Header='<%# GetLangStr("PeccancyRepeatCheck33","处理状态")%>' AutoDataBind="true" Width="100" Sortable="true" DataIndex="col20" Align="Center">
                                    </ext:Column>
                                    <ext:Column Header='<%# GetLangStr("PeccancyRepeatCheck34", "所属机构")%>' AutoDataBind="true" Width="160" Sortable="true" DataIndex="col14" Align="Center">
                                    </ext:Column>
                                </Columns>
                            </ColumnModel>
                            <SelectionModel>
                            ...
                            <Listeners>
                                ...
                                <Command Handler="PeccancyRepeatCheck.VideoShow(command, record.data.col26);" />
                            </Listeners>
                            <DirectEvents>
                ...
                <ext:FormPanel ID="FormPanel1" runat="server" Region="East" Split="true" Frame="true"
                    Title='<%# GetLangStr("PeccancyCheck49","详细信息")%>' Width="0" Height="0" Icon="Images" DefaultAnchor="100%" Collapsible="true"
                                ...
                                <div class="container" style="width: 100%; height: 220px">
                                    <div class="fis">
                                        <img id="zjwj1" style="cursor: pointer" onclick="$.openPhotoGallery(this);" class="photo"
                                            src="../images/NoImage.png" alt="+'<%# GetLangStr("PeccancyQuery48", "车辆图片(图片点击滚轮缩放)")%>'+" width="100%" height="220" />
                                    </div>
...
<script type="text/javascript">
    ...
    var start = {
        ...
        choose: function (datas) {
            ...
            var tt = $("#start").html();
            PeccancyRepeatCheck.GetDateTime(true, tt);
            //alert(tt);
        }
    };
    var end = {
        ...
        choose: function (datas) {
            ...
            var tt = $("#end").html();
            PeccancyRepeatCheck.GetDateTime(false, tt);
        }
    };
    laydate(start);
    laydate(end);
