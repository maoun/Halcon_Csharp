<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PeccancySingleCheck.aspx.cs"
    Inherits="MyNet.Atmcs.Uscmcp.Web.PeccancySingleCheck" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Viewport ID="ViewPort1" runat="server" Layout="border">
            <Items>
                <ext:FormPanel ID="PeccancyCheckPanel" Region="Center" runat="server" Title='<%# GetLangStr("PeccancySingleCheck1","违法车辆")%>'
                    Icon="Lorry" DefaultAnchor="100%">
                    <Items>
                        <ext:BorderLayout ID="BorderLayout1" runat="server">
                            <East Collapsible="true" Split="true">
                                <ext:Panel ID="ZoomPanel" runat="server" Title='<%# GetLangStr("PeccancySingleCheck2","图片放大")%>' Width="300">
                                    <Content>
                                        <center>
                            ...
                            <Center>
                                <ext:TabPanel ID="TabPanel1" runat="server" Region="Center">
                                    <Items>
                                        <ext:Panel ID="ImageDetailPanel" runat="server" Title='<%# GetLangStr("PeccancySingleCheck3","图片信息")%>' Header="false">
                                            <Content>
                                                <center>
                                                    <div class="container">
                                                        <br />
                                        ...
                                        <ext:Panel ID="VideoDetailPanel" runat="server" Title='<%# GetLangStr("PeccancySingleCheck4","视频信息")%>' Header="false">
                                            <Content>
                                                <center>
                                                    <div class="container">
                                                        <br />
                                                    ...
                                                    <br />
                                                    <p>
                                                        <font size="2"><a href="ActiveX/player.exe"><%# GetLangStr("PeccancySingleCheck5","播放控件下载")%></a></font>
                                                    </p>
                                                </center>
                                            </Content>
                                        </ext:Panel>
                                        <ext:Panel ID="MediaPlayerPanel" runat="server" Title='<%# GetLangStr("PeccancySingleCheck6","视频信息")%>' Header="false">
                                            <Content>
                                                <center>
                                                    <div class="container">
                                                        <br />
                            ...
                            <South Collapsible="true" MinHeight="130" Split="true">
                                <ext:Panel runat="server" ID="ImagePanel" Cls="images-view" Frame="true" Height="130"
                                    Collapsible="false" Layout="Fit" Title='<%# GetLangStr("PeccancySingleCheck7","图片列表")%>'>
                                    <Items>
                                        <ext:DataView ID="ImageView" runat="server" StoreID="StoreImage" AutoHeight="true"
                                            MultiSelect="true" OverClass="x-view-over" ItemSelector="div.thumb-wrap" EmptyText='<%# GetLangStr("PeccancySingleCheck8","没有图片")%>'>
                ...
                <ext:FormPanel ID="FrmAmply" runat="server" Region="East" Split="true" Frame="true"
                    ...
                    <Items>
                        <ext:Panel ID="PanAmply" runat="server" Title='<%# GetLangStr("PeccancySingleCheck9","车辆信息")%>' DefaultAnchor="100%" Padding="5">
                            <Items>
                                <ext:Panel ID="CompositeField2" runat="server" Layout="ColumnLayout" Style="margin-bottom: 5px">
                                    <Items>
                                        <ext:Label runat="server" Text='<%# GetLangStr("PeccancySingleCheck10","号牌号码：") %>' StyleSpec="margin-left: 10px;" Style="margin-top: 5px; margin-right: 40px" />
                                        <ext:Panel ID="Panel2" runat="server">
                                            <Content>
                                                <veh:VehicleHead ID="VehicleHead" runat="server" />
                                            </Content>
                                        </ext:Panel>
                                        <ext:TextField ID="txtPlateId" runat="server" Width="222" EmptyText="六位号牌号码">
                                            <Listeners>
                                ...
                                <ext:ComboBox runat="server" FieldLabel='<%# GetLangStr("PeccancySingleCheck11","号牌种类") %>' ID="cmbPlateType" StoreID="StorePlateType"
                                    Editable="false" DisplayField="col1" ValueField="col0" Mode="Local" TriggerAction="All"
                                    EmptyText='<%# GetLangStr("PeccancySingleCheck12","选择号牌种类")%>' Width="370">
                                    <Triggers>
                                ...
                                <ext:TextField runat="server" FieldLabel='<%# GetLangStr("PeccancySingleCheck13","违法时间")%>' ID="TxtPeccancyDate" Width="370" ReadOnly="true" />
                                <ext:ComboBox runat="server" FieldLabel='<%# GetLangStr("PeccancySingleCheck14","违法地点")%>' ID="cmbLocation" StoreID="StoreLocation"
                                    Editable="false" DisplayField="col1" ValueField="col0" Mode="Local" TriggerAction="All"
                                    EmptyText='<%# GetLangStr("PeccancySingleCheck15","选择违法地点")%>' Width="370">
                                    <Triggers>
                                        <ext:FieldTrigger Icon="Clear" HideTrigger="true" Qtip="清除选中" />
                                    </Triggers>
                                    <Listeners>
                                ...
                                <ext:ComboBox ID="cmbPeccancyType" FieldLabel='<%# GetLangStr("PeccancySingleCheck16","违法行为")%>' runat="server" StoreID="StorePeccancyType"
                                    Editable="false" DisplayField="col2" ValueField="col1" Mode="Local" TriggerAction="All"
                                    EmptyText='<%# GetLangStr("PeccancySingleCheck17","选择违法行为")%>' Width="370">
                                    <Triggers>
                                        <ext:FieldTrigger Icon="Clear" HideTrigger="true" Qtip="清除选中" />
                                    </Triggers>
                                    <Listeners>
                                ...
                                <ext:TextField runat="server" FieldLabel='<%# GetLangStr("PeccancySingleCheck18","速度/限速")%>' ID="TxtSpeed" Width="370" ReadOnly="true" />
                            </Items>
                        </ext:Panel>
                        ...
                        <ext:Toolbar ID="Toolbar4" runat="server" Layout="Container">
                            <Items>
                                <ext:Panel ID="pnlPackCenter" runat="server" Layout="HBoxLayout">
                                    ...
                                    <LayoutConfig>
                                        <ext:HBoxLayoutConfig Padding="1" Align="Middle" Pack="Center" />
                                    </LayoutConfig>
                                    <Items>
                                        ...
                                        <ext:Button ID="ButLast" runat="server" Text='<%# GetLangStr("PeccancySingleCheck29","上一条")%>' Icon="ReverseGreen">
                                            <Listeners>
                                                <Click Handler="PeccancySingleCheck.LastInfo()" />
                                            </Listeners>
                                        </ext:Button>
                                        <ext:Button ID="ButNext" runat="server" Text='<%# GetLangStr("PeccancySingleCheck30","下一条")%>' Icon="PlayGreen">
                                            <Listeners>
                                ...
                                <ext:Panel ID="Panel1" runat="server" Layout="HBoxLayout">
                                    ...
                                    <Items>
                                        <ext:Button ID="ButQuery" runat="server" Text='<%# GetLangStr("PeccancySingleCheck32","查询")%>' Icon="ControlPlayBlue" Height="30">
                                            <DirectEvents>
                                                <Click OnEvent="ButQueryClick" />
                                            </DirectEvents>
                                        </ext:Button>
                                        <ext:Button ID="ButCheckOk" runat="server" Text='<%# GetLangStr("PeccancySingleCheck33","有效")%>' Icon="Accept" Height="30">
                                            <DirectEvents>
                                                <Click OnEvent="ButCheckOkClick" />
                                            </DirectEvents>
                                        </ext:Button>
                                        <ext:Button ID="ButCheckNo" runat="server" Text='<%# GetLangStr("PeccancySingleCheck34","无效")%>' Icon="Decline" Height="30">
                                            <DirectEvents>
                                                <Click OnEvent="ButCheckNoClick" />
                                            </DirectEvents>
                                        </ext:Button>
                                        <ext:Button ID="ButCheckRpeat" runat="server" Text='<%# GetLangStr("PeccancySingleCheck35","套牌")%>' Icon="CarAdd" Height="30">
                                            <DirectEvents>
