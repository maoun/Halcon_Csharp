<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PeccancyOperateLog.aspx.cs" Inherits="MyNet.Atmcs.Uscmcp.Web.PeccancyOperateLog" %>
                    ...
                    <TopBar>
                        <ext:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                ...
                                <ext:Label ID="Label1" runat="server" Text='<%# GetLangStr("LogRunning2","查询类型：") %>' StyleSpec="margin-left: 10px;">
                                </ext:Label>
                                <ext:ComboBox ID="CmbQueryType" runat="server" Editable="false" DisplayField="col1"
                                    ValueField="col0" TypeAhead="true" Mode="Local" ForceSelection="true" EmptyText='<%# GetLangStr("LogRunning3","请选择...")%>'
                                ...
                                <ext:Label ID="Label3" runat="server" Text="号牌号码： " StyleSpec="margin-left: 10px;">
                                </ext:Label>
                                <ext:TextField runat="server" ID="txtHphm" Width="100"></ext:TextField>
                                <ext:Button ID="TbutQuery" runat="server" Icon="ControlPlayBlue" Text='<%# GetLangStr("LogRunning4","查询")%>' StyleSpec="margin-left: 10px;">
                                    <DirectEvents>
                ...
                <ext:GridPanel ID="GridPanel1" runat="server" StripeRows="true" AutoExpandColumn="userevent"
                    ...
                    <ColumnModel ID="ColumnModel1" runat="server">
                        <Columns>
                            ...
                            <ext:Column Header='<%# GetLangStr("LogRunning42", "操作类型")%>' AutoDataBind="true" Align="Center" Sortable="true" DataIndex="col6" Width="90" />
                            <ext:Column Header='<%# GetLangStr("LogRunning9", "操作事件")%>' Align="left" AutoDataBind="true" Sortable="true" DataIndex="col2" ColumnID="userevent" />
                            <ext:Column Header='<%# GetLangStr("LogRunning10", "用户IP" )%>' AutoDataBind="true" Align="Center" Sortable="true" DataIndex="col3" Width="100" />
                            <ext:DateColumn Header='<%# GetLangStr("LogRunning11","记录时间")%>' AutoDataBind="true" Align="Center" Sortable="true" DataIndex="col4" Format="yyyy-MM-dd HH:mm:ss" Width="150" />
                            <ext:Column Header="号牌号码" AutoDataBind="true" Align="Center" Sortable="true" DataIndex="col7" Width="90" />
                        </Columns>
                    </ColumnModel>
                    <SelectionModel>
                    ...
                    <TopBar>
                        <ext:PagingToolbar HideRefresh="true" ID="PagingToolbar1" runat="server" PageSize="15" StoreID="StoreRunning">
                            <Items>
                                <ext:Button ID="ButExcel" runat="server" Text='<%# GetLangStr("LogRunning14","导出Excel")%>' AutoPostBack="true" OnClick="ToExcel"
                                    Icon="PageExcel">
                                </ext:Button>
                            </Items>
                        </ext:PagingToolbar>
