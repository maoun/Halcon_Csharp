<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PassAlarmQuery.aspx.cs" Inherits="MyNet.Atmcs.Uscmcp.Web.PassAlarmQuery" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:ResourceManager ID="ResourceManager1" runat="server" DirectMethodNamespace="PassAlarmQuery">
            <%--  <CustomDirectEvents>
                        ...
                        <ext:Panel runat="server" ColumnWidth=".98" HideBorders="true" Layout="RowLayout">
                            <Items>
                                    ...
                                    <Items>
                                        <ext:Toolbar runat="server">
                                            <Items>
                                                ...
                                                <ext:Panel runat="server" Height="40">
                                                    <Content>
                                                        <table style="width: 400px">
                                                            <tr>
                                                                <td style="width: 50px">
                                                                    <span class="laydate-span" style="height: 30px; font-size: 15px; margin-left: 12px; margin-right: 2px; margin-top: 5px;"><%# GetLangStr("PassAlarmQuery65","查询时间：") %></span></td>
                                                ...
                                                <ext:Label ID="Label1" runat="server" Text='<%# GetLangStr("PassAlarmQuery1","号牌种类：") %>' StyleSpec=" margin-top:10px; margin-left:45px; float: left; height: 30px; line-height: 30px!important; text-align: center;">
                                                </ext:Label>
                                                <ext:ComboBox Height="30" ID="CmbPlateType" runat="server" Editable="false" DisplayField="col1" StoreID="StorePlateType"
                                                    ValueField="col0" TypeAhead="true" Mode="Local" ForceSelection="true" EmptyText='<%# GetLangStr("PassAlarmQuery2","请选择...") %>'
                                                    SelectOnFocus="true" Width="150">
                                                    <Triggers>
                                                        <ext:FieldTrigger Icon="Clear" HideTrigger="true" Qtip='<%# GetLangStr("PassAlarmQuery3","清除选中") %>' AutoDataBind="true" />
                                                    </Triggers>
                                                    <Listeners>
                                                ...
                                                <ext:Label ID="Label3" runat="server" Text='<%# GetLangStr("PassAlarmQuery4","号牌号码：") %>' StyleSpec="margin-top:10px;margin-left:40px;   float: left;  height: 30px; line-height: 30px!important; text-align: center">
                                                </ext:Label>
                                                ...
                                                <ext:Panel runat="server" Layout="ColumnLayout" Height="30">
                                                    <Items>
                                                        <ext:TextField ID="TxtplateId" runat="server" Hidden="false" MaxLength="6" Width="150" Height="30" EmptyText='<%# GetLangStr("PassAlarmQuery5","六位号牌号码") %>'>
                                                            <Listeners>
                                                                <Change Fn="change" />
                                                            </Listeners>
                                                        </ext:TextField>
                                                ...
                                                <ext:Panel runat="server" StyleSpec="margin-left:0px;">
                                                    <Items>
                                                        <ext:Checkbox runat="server" ID="cktype" Checked="false" BoxLabel='<%# GetLangStr("PassAlarmQuery6","模糊查询") %>' StyleSpec="margin-left:0px;">
                                                            <DirectEvents>
                                        ...
                                        <ext:Toolbar runat="server">
                                            <Items>
                                                ...
                                                <ext:Panel runat="server">
                                                    <Content>
                                                        <div style="width: 512px; height: 40px;">
                                                            <span style="margin-top: 5px; font-size: 15px; margin-left: 13px; margin-right: 10px; float: left;"><%# GetLangStr("PassAlarmQuery7","卡口列表：") %></span>
                                                ...
                                                <ext:Label ID="Label5" runat="server" Text='<%# GetLangStr("PassAlarmQuery8","车身颜色：") %>' StyleSpec="margin-top:5px;margin-left:23px;margin-right:0px;float: left;  height: 30px; line-height: 30px!important; text-align: center"></ext:Label>
                                                <ext:ComboBox ID="CmbCsys" runat="server" Editable="false" DisplayField="col1"
                                                    ValueField="col0" TypeAhead="true" Mode="Local" ForceSelection="true" EmptyText='<%# GetLangStr("PassAlarmQuery9","选择车身颜色...") %>'
                                                ...
                                                <ext:Button ID="Button1" runat="server" Icon="ControlPlayBlue" Text='<%# GetLangStr("PassAlarmQuery10","查询")%>' StyleSpec="margin-left:40px;">
                                                    <DirectEvents>
                                                ...
                                                <ext:Button ID="Button2" runat="server" Icon="ControlBlank" Text='<%# GetLangStr("PassAlarmQuery11","重置")%>'>
                                                    <DirectEvents>
                                ...
                                <ext:Panel runat="server" HideBorders="true" Height="24">
                                    <Content>
                                        <li id="morelist"><a><span class="act" style="color: #fc5004; cursor: pointer; -moz-user-select: none; -webkit-user-select: none"><%# GetLangStr("PassAlarmQuery12","高级查询") %></span></a><img class="act" alt="" id="transform" src="../Image/jiantou-down.png" style="margin-left: 10px; cursor: pointer"></img></li>
                                    </Content>
                                </ext:Panel>
                                    ...
                                    <Items>
                                        <ext:Toolbar runat="server">
                                            <Items>
                                                        ...
                                                        <ext:Panel runat="server">
                                                            <Content>
                                                                ...
                                                                <div style="margin-top: 5px;">
                                                                    <span style="margin-left: 15px; margin-right: 2px;"><%# GetLangStr("PassAlarmQuery13","车辆品牌：") %></span>
                                                                </div>
                                                            </Content>
                                                        </ext:Panel>
                                                        <ext:Panel runat="server">
                                                ...
                                                <ext:Label ID="Label9" runat="server" Text='<%# GetLangStr("PassAlarmQuery14","行驶方向：") %>' StyleSpec="margin-top:10px;margin-left:10px;float: left;  height: 30px; line-height:30px!important; text-align: center">
                                                </ext:Label>
                                                <ext:ComboBox ID="CmbXsfx" runat="server" Editable="false" DisplayField="col1"
                                                    ValueField="col0" TypeAhead="true" Mode="Local" ForceSelection="true" EmptyText='<%#GetLangStr("PassAlarmQuery15","选择行驶方向...") %>'
                                                    SelectOnFocus="true" StoreID="StoreXsfx" Width="132">
                                                    <Triggers>
                                                        <ext:FieldTrigger Icon="Clear" HideTrigger="true" Qtip='<%# GetLangStr("PassAlarmQuery3","清除选中") %>' />
                                                    </Triggers>
                                                    <Listeners>
                                                        <Select Handler="this.triggers[0].show();" />
                                                        <BeforeQuery Handler="this.triggers[0][ this.getRawValue().toString().length == 0 ? 'hide' : 'show']();" />
                                                ...
                                                <ext:Label ID="Label6" runat="server" Text='<%# GetLangStr("PassAlarmQuery16","车速(km/h)：") %>' Style="margin-left: 35px;" />
                                                ...
                                                <ext:Label ID="Label10" runat="server" Text='<%# GetLangStr("PassAlarmQuery17","车道编号：") %>' StyleSpec="margin-top:13px;margin-left:42px;margin-right:2px;float: left;  height: 30px; line-height: 30px!important; text-align: center">
                                                </ext:Label>
                                ...
                                <ext:Panel runat="server" RowHeight=".6" HideBorders="true" ColumnWidth="1" Layout="FitLayout">
                                    ...
                                    <Items>
                                        <%--中间--%>
                                        <ext:FormPanel ID="FormPanel2" Region="Center" runat="server" Title='<%# GetLangStr("PassAlarmQuery18","查询结果") %>' Layout="FitLayout">
                                            <TopBar>
                                                <%--分页--%>
                                                <ext:Toolbar ID="Toolbar2" runat="server" Flat="false">
                                                    <Items>
                                                        <ext:Label ID="LabNum" runat="server"  Text='<%# GetLangStr("PassAlarmQuery19","当前0页,共0页") %>' > 
                                                        </ext:Label>
                                                        <ext:ToolbarSpacer ID="ToolbarSpacer3" runat="server" Width="10" />
                                                        <ext:Button ID="ButFisrt" runat="server" Text='<%# GetLangStr("PassAlarmQuery20","首页") %>' Disabled="true">
                                                            <DirectEvents>
                                                                <Click OnEvent="TbutFisrt" />
                                                            </DirectEvents>
                                                        </ext:Button>
                                                        <ext:Button ID="ButLast" runat="server" Icon="ControlRewindBlue" Text='<%# GetLangStr("PassAlarmQuery21","上一页" ) %>' Disabled="true" StyleSpec="margin-left:10px;">
                                                            <DirectEvents>
                                                                <Click OnEvent="TbutLast" />
                                                            </DirectEvents>
                                                        </ext:Button>
                                                        <ext:Button ID="ButNext" runat="server" Icon="ControlFastforwardBlue" Text='<%# GetLangStr("PassAlarmQuery22","下一页") %>'  StyleSpec="margin-left:10px;"
                                                            Disabled="true">
                                                            <DirectEvents>
                                                                <Click OnEvent="TbutNext" />
                                                            </DirectEvents>
                                                        </ext:Button>
                                                        <ext:Button ID="ButEnd" runat="server" Text='<%# GetLangStr("PassAlarmQuery23","尾页") %>' Disabled="true" StyleSpec="margin-left:10px;">
                                                            <DirectEvents>
                                                        ...
                                                        <ext:Button ID="ButExcel" runat="server" Text='<%# GetLangStr("PassAlarmQuery24","导出Excel") %>' AutoPostBack="true" OnClick="ToExcel"
                                                            Icon="PageExcel">
                                                        </ext:Button>
                                                    </Items>
                                                </ext:Toolbar>
                                            ...
                                            <Items>
                                                <%--数据展示--%>
                                                <ext:GridPanel ID="GridAlarmInfo" runat="server" StripeRows="true" BodyStyle="height:100%;width:100%"
                                                    TrackMouseOver="true">
                                                    <Store>
                                                    ...
                                                    <ColumnModel ID="ColumnModel1" runat="server">
                                                        <Columns>
                                                            ...
                                                            <ext:Column ColumnID="Details" Header='<%# GetLangStr("PassAlarmQuery25","详细") %>' AutoDataBind="true"  Width="50" Align="Center" Fixed="true"
                                                                MenuDisabled="true" Resizable="false">
                                                                <Renderer Fn="DataAmply" />
                                                            </ext:Column>
                                                            <ext:Column Header='<%# GetLangStr("PassAlarmQuery26","记录编号") %>'  AutoDataBind="true" Width ="100" Sortable="true" DataIndex="col0" Hidden="true" />
                                                            <ext:Column Header='<%# GetLangStr("PassAlarmQuery27","报警卡口") %>' AutoDataBind="true"  Width="150" Sortable="true" DataIndex="col9" Align="Left">
                                                            </ext:Column>
                                                            <ext:Column Header='<%# GetLangStr("PassAlarmQuery28","号牌号码") %>' AutoDataBind="true"  Width="75" Sortable="true" DataIndex="col3" Align="Center">
                                                            </ext:Column>
                                                            <ext:Column Header='<%# GetLangStr("PassAlarmQuery29","号牌种类") %>' AutoDataBind="true"  Width="80" Sortable="true" DataIndex="col2" Align="Center">
                                                            </ext:Column>
                                                            <ext:DateColumn Header='<%# GetLangStr("PassAlarmQuery30","报警时间") %>'  AutoDataBind="true" DataIndex="col4" Width="120" Format="yyyy-MM-dd HH:mm:ss" Align="Center" />
                                                            <ext:Column Header='<%# GetLangStr("PassAlarmQuery31","报警类型") %>' AutoDataBind="true"  Width="150" Sortable="true" DataIndex="col6" Align="Center">
                                                            </ext:Column>
                                                            <ext:Column Header='<%# GetLangStr("PassAlarmQuery32","报警原因") %>'  AutoDataBind="true" Width="200" Sortable="true" DataIndex="col7" Align="Center">
                                                            </ext:Column>
                                                            <ext:Column Header='<%# GetLangStr("PassAlarmQuery33","处理状态") %>' AutoDataBind="true"  Width="80" Sortable="true" DataIndex="col18" Align="Center">
                                                            </ext:Column>
                                                        </Columns>
                                                    </ColumnModel>
                                                    <SelectionModel>
                                                        ...
                                                        <div class="container" style="width: 100%; height: 220px">
                                                            <div class="fis">
                                                                <img id="zjwj1" style="cursor: pointer" class="photo"
                                                                    src="../images/NoImage.png" alt='<%# GetLangStr("PassAlarmQuery34","车辆图片(图片点击滚轮缩放)") %>' width="100%" height="220" onclick="$.openPhotoGallery(this);" />
                                                            </div>
        ...
        <ext:Window runat="server" ID="Window1" Title='<%# GetLangStr("PassAlarmQuery35","卡口选择") %>' Hidden="true" Maximizable="true"
            Modal="true" Width="1000" Height="600" ButtonAlign="Center">
            <AutoLoad
                Url="../Map/MapStation.aspx"
                Mode="IFrame"
                ShowMask="true"
                MaskMsg='<%# GetLangStr("PassAlarmQuery36","加载中...") %>' />
            <%--  <Buttons>
        ...
        <div>
            <div id="menuContent" class="menuContent" style="display: none; position: absolute; z-index: 999; width: 389px; height: 377px;">
                ...
                <div style="position: relative; bottom: 0; height: 5%; padding-bottom: 10px; border-radius: 0px 0px 15px 15px;" class="kkselectStyle">
                    <input type="button" value='<%# GetLangStr("PassAlarmQuery37","清除" ) %>'class="func_btn" onclick="clearMenu()" style="margin-left: 100px;" />

                    <input type="button" value='<%# GetLangStr("PassAlarmQuery38","关闭") %>' class="func_btn" onclick="hideMenu()" />
                </div>
            </div>
            <div id="selectKakou" style="display: none; position: absolute; z-index: 999; width: 389px; height: 377px; overflow-y: auto; overflow-x: hidden;">
                ...
                <div style="position: relative; bottom: 0; height: 5%; padding-bottom: 10px;  border-radius: 0px 0px 15px 15px;" class="kkselectStyle">
                    <input type="button" class="func_btn" value='<%# GetLangStr("PassAlarmQuery39","返回目录" ) %>'onclick="returnKakou()" style="margin-left: 100px;" />

                    <input type="button" class="func_btn" value='<%# GetLangStr("PassAlarmQuery38","关闭") %>' onclick="hideMenuSelect()" />
                </div>
            </div>
        </div>
        <!-- 显示卡口下拉框结束-->
...
<script type="text/javascript">
    ...
    var start = {
        ...
        choose: function (datas) {
            ...
            var tt = $("#start").html();
            PassAlarmQuery.GetDateTime(true, tt);
        }
    ...
    var end = {
        ...
        choose: function (datas) {
            ...
            var tt = $("#end").html();
            PassAlarmQuery.GetDateTime(false, tt);
        }
    };
    laydate(start);
    laydate(end);
