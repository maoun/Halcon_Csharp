<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PassCarInfoQuery.aspx.cs" Inherits="MyNet.Atmcs.Uscmcp.Web.PassCarInfoQuery" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function ShowImage(palteid, platetype, image1, image2, image3) {
            if (image1 == null || image1 == undefined || image1 == '') {
                image1 = "../images/NoImage.png";
            }
            if (image2 == null || image2 == undefined || image2 == '') {
                image2 = "../images/NoImage.png";
            }
            if (image3 == null || image3 == undefined || image3 == '') {
                image3 = "../images/NoImage.png";
            }
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <ext:ResourceManager ID="ResourceManager1" runat="server" DirectMethodNamespace="PassCarInfoQuery">
            <%-- <CustomDirectEvents>
        ...
        <ext:Store ID="StoreZfgg" runat="server">
            <Reader>
                <ext:JsonReader>
                    <Fields>
                        <ext:RecordField Name="col0" Type="String" />
                        ...
                        <ext:Panel runat="server" ColumnWidth=".98" HideBorders="true" Layout="RowLayout">
                            <Items>
                                    ...
                                    <Items>
                                        <ext:Toolbar runat="server">
                                            <Items>
                                                ...
                                                <ext:Panel runat="server" Height="40">
                                                    <Content>
                                                        <table style="width: 400px">
                                                            <tr>
                                                                <td style="width: 50px">
                                                                    <span class="laydate-span" style="height: 30px; font-size: 15px; margin-left: 12px; margin-right: 2px; margin-top: 5px;"><%# GetLangStr("PassCarInfoQuery81","查询时间：") %></span></td>
                                                ...
                                                <ext:Label ID="Label1" runat="server" Text='<%# GetLangStr("PassCarInfoQuery1","号牌种类：") %>' StyleSpec=" margin-top:10px; margin-left:45px;margin-right:0px; float: left; height: 30px; line-height: 30px!important; text-align: center;">
                                                </ext:Label>
                                                <ext:ComboBox Height="30" ID="CmbPlateType" runat="server" Editable="false" DisplayField="col1" StoreID="StorePlateType"
                                                    ValueField="col0" TypeAhead="true" Mode="Local" ForceSelection="true" EmptyText='<%# GetLangStr("PassCarInfoQuery2","请选择...") %>'
                                                    SelectOnFocus="true" Width="150">
                                                    <Triggers>
                                                        <ext:FieldTrigger Icon="Clear" HideTrigger="true" Qtip='<%# GetLangStr("PassCarInfoQuery3","清除选中") %>' AutoDataBind="true" />
                                                    </Triggers>
                                                    <Listeners>
                                                ...
                                                <ext:Label ID="Label3" runat="server" Text='<%# GetLangStr("PassCarInfoQuery4","号牌号码：") %>' StyleSpec="margin-top:10px;margin-left:40px;   float: left;  height: 30px; line-height: 30px!important; text-align: center">
                                                </ext:Label>
                                                ...
                                                <%-- <ext:Panel runat="server" Layout="ColumnLayout" Height="30">
                                                    <Items>
                                                        <ext:TextField ID="TxtplateId" runat="server" Hidden="false" MaxLength="6" Width="150" Height="30" EmptyText="六位号牌号码">
                                                            <Listeners>
                                                                <Change Fn="change" />
                                                            </Listeners>
                                                        </ext:TextField>

                                                        <ext:Panel runat="server" ID="pnhphm" Hidden="true" Width="206" Layout="ColumnLayout">
                                                            <Items>
                                                                <ext:TextField ID="labelhm1" Hidden="false" Height="30" MaxLength="1" runat="server" Width="35" Cls="ui-input">
                                                                    <Listeners>
                                                                        <Change Fn="change" />
                                                                    </Listeners>
                                                                </ext:TextField>

                                                                <ext:TextField ID="labelhm2" Hidden="false" Height="30" MaxLength="1" runat="server" Width="35" Cls="ui-input" StyleSpec="margin-left:5px">
                                                                    <Listeners>
                                                                        <Change Fn="change" />
                                                                    </Listeners>
                                                                </ext:TextField>

                                                                <ext:TextField ID="labelhm3" Hidden="false" Height="30" MaxLength="1" runat="server" Width="35" Cls="ui-input" StyleSpec="margin-left:5px">
                                                                    <Listeners>
                                                                        <Change Fn="change" />
                                                                    </Listeners>
                                                                </ext:TextField>

                                                                <ext:TextField ID="labelhm4" Hidden="false" Height="30" MaxLength="1" runat="server" Width="35" Cls="ui-input" StyleSpec="margin-left:5px">
                                                                    <Listeners>
                                                                        <Change Fn="change" />
                                                                    </Listeners>
                                                                </ext:TextField>

                                                                <ext:TextField ID="labelhm5" Hidden="false" Height="30" MaxLength="1" runat="server" Width="35" Cls="ui-input" StyleSpec="margin-left:5px">
                                                                    <Listeners>
                                                                        <Change Fn="change" />
                                                                    </Listeners>
                                                                </ext:TextField>

                                                                <ext:TextField ID="labelhm6" Hidden="false" Height="30" MaxLength="1" runat="server" Width="35" Cls="ui-input" StyleSpec="margin-left:5px;">
                                                                    <Listeners>
                                                                        <Change Fn="change" />
                                                                    </Listeners>
                                                                </ext:TextField>
                                                ...
                                                <ext:Panel runat="server" Layout="ColumnLayout" Height="30">
                                                    <Items>
                                                        <ext:TextField ID="TxtplateId" runat="server" Hidden="false" MaxLength="6" Width="150" Height="30" EmptyText='<%# GetLangStr("PassCarInfoQuery5","六位号牌号码") %>'>
                                                            <Listeners>
                                                                <Change Fn="change" />
                                                            </Listeners>
                                                        </ext:TextField>
                                                ...
                                                <ext:Panel runat="server" StyleSpec="margin-left:0px;">
                                                    <Items>
                                                        <ext:Checkbox runat="server" ID="cktype" Checked="false" BoxLabel='<%# GetLangStr("PassCarInfoQuery6","模糊查询") %>' StyleSpec="margin-left:0px;">
                                                            <DirectEvents>
                                        ...
                                        <ext:Toolbar runat="server">
                                            <Items>
                                                ...
                                                <ext:Panel runat="server">
                                                    <Content>
                                                        <div style="width: 512px; height: 40px;">
                                                            <span style="margin-top: 5px; font-size: 15px; margin-left: 13px; margin-right: 10px; float: left;"><%# GetLangStr("PassCarInfoQuery82","卡口列表：") %></span>
                                                ...
                                                <ext:Label ID="Label5" runat="server" Text='<%# GetLangStr("PassCarInfoQuery7","车身颜色：") %>' StyleSpec="margin-top:5px;margin-left:23px;margin-right:0px;float: left;  height: 30px; line-height: 30px!important; text-align: center"></ext:Label>
                                                <ext:ComboBox ID="CmbCsys" runat="server" Editable="false" DisplayField="col1"
                                                    ValueField="col0" TypeAhead="true" Mode="Local" ForceSelection="true" EmptyText='<%# GetLangStr("PassCarInfoQuery8","选择车身颜色...") %>'
                                                ...
                                                <ext:Button ID="Button1" runat="server" Icon="ControlPlayBlue" Text='<%# GetLangStr("PassCarInfoQuery9","查询")%>' StyleSpec="margin-left:40px;">
                                                    <DirectEvents>
                                                ...
                                                <ext:Button ID="Button2" runat="server" Icon="ControlBlank" Text='<%# GetLangStr("PassCarInfoQuery10","重置")%>'>
                                                    <DirectEvents>
                                ...
                                <ext:Panel runat="server" HideBorders="true" Height="24">
                                    <Content>
                                        <li id="morelist"><a><span class="act" style="color: #fc5004; cursor: pointer; -moz-user-select: none; -webkit-user-select: none"><%# GetLangStr("PassCarInfoQuery11","高级查询") %></span></a><img class="act" alt="" id="transform" src="../Image/jiantou-down.png" style="margin-left: 10px; cursor: pointer"></img></li>
                                    </Content>
                                </ext:Panel>
                                    ...
                                    <Items>
                                        <ext:Toolbar runat="server">
                                            <Items>
                                                        ...
                                                        <ext:Panel runat="server">
                                                            <Content>
                                                                ...
                                                                <div style="margin-top: 5px;">
                                                                    <span style="margin-left: 15px; margin-right: 2px;"><%# GetLangStr("PassCarInfoQuery83","车辆品牌：") %></span>
                                                                </div>
                                                            </Content>
                                                        </ext:Panel>
                                                        <ext:Panel runat="server">
                                                ...
                                                <ext:Label ID="Label9" runat="server" Text='<%# GetLangStr("PassCarInfoQuery12","行驶方向：") %>' StyleSpec="margin-top:10px;margin-left:10px;float: left;  height: 30px; line-height:30px!important; text-align: center">
                                                </ext:Label>
                                                <ext:ComboBox ID="CmbXsfx" runat="server" Editable="false" DisplayField="col1"
                                                    ValueField="col0" TypeAhead="true" Mode="Local" ForceSelection="true" EmptyText='<%#GetLangStr("PassCarInfoQuery13","选择行驶方向...") %>'
                                                ...
                                                <ext:Label ID="Label6" runat="server" Text='<%# GetLangStr("PassCarInfoQuery14","车速(km/h)：") %>' Style="margin-left: 35px;" />
                                                ...
                                                <ext:Label ID="Label10" runat="server" Text='<%# GetLangStr("PassCarInfoQuery15","车道编号：") %>' StyleSpec="margin-top:13px;margin-left:42px;margin-right:2px;float: left;  height: 30px; line-height: 30px!important; text-align: center">
                                                </ext:Label>
                                ...
                                <%-- 查询--%>
                                <ext:Panel runat="server" RowHeight=".8" HideBorders="true" ColumnWidth="1" ID="panelInfo" Layout="FitLayout">
                                    <Items>
                                        <%--中部--%>
                                        <ext:FormPanel ID="FormPanel2" runat="server" Title='<%# GetLangStr("PassCarInfoQuery16","查询结果") %>' Layout="FitLayout">
                                            <TopBar>
                                                <ext:Toolbar ID="Toolbar2" runat="server" Layout="Container" Flat="false">
                                                    <Items>
                                                        <ext:Toolbar runat="server">
                                                            <Items>
                                                                <ext:Label ID="LabNum" runat="server" Text='<%# GetLangStr("PassCarInfoQuery17","当前0页,共0页") %>'>
                                                                </ext:Label>
                                                                <ext:ToolbarSpacer ID="ToolbarSpacer3" runat="server" Width="10" />
                                                                <ext:Button ID="ButLast" runat="server" Icon="ControlRewindBlue" Text='<%# GetLangStr("PassCarInfoQuery18","上一页") %>' Disabled="true">
                                                                    <DirectEvents>
                                                                        <Click OnEvent="TbutLast" />
                                                                    </DirectEvents>
                                                                </ext:Button>
                                                                <ext:Button ID="ButNext" runat="server" Icon="ControlFastforwardBlue" StyleSpec="margin-left:10px;" Text='<%# GetLangStr("PassCarInfoQuery19","下一页") %>'
                                                                    Disabled="true">
                                                                    <DirectEvents>
                                                                ...
                                                                <ext:Button ID="ButExcel" runat="server" Text='<%# GetLangStr("PassCarInfoQuery20","导出Excel") %>' AutoPostBack="true" OnClick="ToExcel"
                                                                    Icon="PageExcel">

                                                                    <%-- <DirectEvents>
                                                                      <Click OnEvent="ToExcel">
                                                                          <EventMask ShowMask="true" Msg="正在加载Excel中..." ></EventMask>
                                                                      </Click>
                                                                  </DirectEvents>--%>
                                                                </ext:Button>
                                            ...
                                            <Items>
                                                <ext:GridPanel ID="GridPanel1" runat="server" StripeRows="true" Header="false" BodyStyle="height:100%;width:100%" Collapsible="true" TrackMouseOver="true">
                                                    ...
                                                    <ColumnModel ID="ColumnModel1" runat="server">
                                                        <Columns>
                                                            ...
                                                            <ext:Column ColumnID="Details" Header='<%# GetLangStr("PassCarInfoQuery21","详细") %>' AutoDataBind="true" Width="50" Align="Center" Fixed="true"
                                                                MenuDisabled="true" Resizable="false">
                                                                <Renderer Fn="DataAmply" />
                                                            </ext:Column>
                                                            <ext:Column Header='<%# GetLangStr("PassCarInfoQuery22","记录编号") %>' AutoDataBind="true" Width="100" Sortable="true" DataIndex="col0" Hidden="true" />
                                                            <ext:Column Header='<%# GetLangStr("PassCarInfoQuery23","卡口名称") %>' AutoDataBind="true" Width="120" Sortable="true" DataIndex="col2" Align="Left">
                                                            </ext:Column>
                                                            <ext:Column Header='<%# GetLangStr("PassCarInfoQuery24","号牌号码") %>' AutoDataBind="true" Width="75" Sortable="true" DataIndex="col3" Align="Center">
                                                            </ext:Column>
                                                            <ext:Column Header='<%# GetLangStr("PassCarInfoQuery25","号牌种类") %>' AutoDataBind="true" Width="100" Sortable="true" DataIndex="col5" Align="Center">
                                                            </ext:Column>
                                                            <ext:Column Header='<%# GetLangStr("PassCarInfoQuery26","过往时间") %>' AutoDataBind="true" DataIndex="col6" Width="120" Align="Center" />
                                                            <ext:Column Header='<%# GetLangStr("PassCarInfoQuery12","行驶方向") %>' AutoDataBind="true" Width="80" Sortable="true" DataIndex="col8" Align="Center">
                                                            </ext:Column>
                                                            <ext:Column Header='<%# GetLangStr("PassCarInfoQuery15","车道编号") %>' AutoDataBind="true" Width="40" Sortable="true" DataIndex="col9" Align="Center">
                                                            </ext:Column>
                                                            <ext:Column Header='<%# GetLangStr("PassCarInfoQuery29","车辆速度") %>' AutoDataBind="true" Width="60" Sortable="true" DataIndex="col10" Align="Center">
                                                            </ext:Column>
                                                            <ext:Column Header='<%# GetLangStr("PassCarInfoQuery20","导出Excel") %>' AutoDataBind="true" Width="100" Sortable="true" DataIndex="col12" Align="Center">
                                                            </ext:Column>
                                                            <ext:Column ColumnID="userevent" Header='<%# GetLangStr("PassCarInfoQuery31","记录类型") %>' AutoDataBind="true" Width="100" Sortable="true" DataIndex="col14" Align="Center">
                                                            </ext:Column>
                                                        </Columns>
                                                    </ColumnModel>
                                                    <SelectionModel>
                                                        <ext:RowSelectionModel ID="RowSelectionModel1" runat="server" SingleSelect="true">
                                                            <Listeners>
                                                                <RowSelect Handler="ShowImage(record.data.col3,record.data.col4,record.data.col15,record.data.col16,record.data.col17)" Buffer="250" />
                                                            </Listeners>
                                        ...
                                        <%--详细信息--%>
                                        <ext:FormPanel ID="FormPanel1" runat="server" Split="true" Frame="true"
                                            Title='<%# GetLangStr("PassCarInfoQuery32","详细信息") %>' Width="0" Height="0" Icon="Images" DefaultAnchor="100%" Collapsible="true"
                                                        ...
                                                        <div class="container" style="width: 100%; height: 220px">
                                                            <div class="fis">
                                                                ...
                                                                <img id="zjwj1" style="cursor: pointer" class="photo"
                                                                    src="../images/NoImage.png" alt='<%# GetLangStr("PassCarInfoQuery33","车辆图片(图片点击滚轮缩放)") %>' width="100%" height="220" onclick="$.openPhotoGallery(this);" />
                                                            </div>
        ...
        <ext:Window runat="server" ID="Window1" Title='<%# GetLangStr("PassCarInfoQuery34","卡口选择") %>' Hidden="true" Maximizable="true"
        ...
        <div>
            <div id="menuContent" class="menuContent" style="display: none; position: absolute; z-index: 999; width: 389px; height: 377px;">
                ...
                <div style="position: relative; bottom: 0; height: 5%; padding-bottom: 10px; border-radius: 0px 0px 15px 15px;" class="kkselectStyle">
                    <input type="button" value='<%# GetLangStr("PassCarInfoQuery35","清除") %>' class="func_btn" onclick="clearMenu()" style="margin-left: 100px;" />

                    <input type="button" value='<%# GetLangStr("PassCarInfoQuery36","关闭") %>' class="func_btn" onclick="hideMenu()" />
                </div>
            </div>
            <div id="selectKakou" style="display: none; position: absolute; z-index: 999; width: 389px; height: 377px; overflow-y: auto; overflow-x: hidden;">
                ...
                <div style="position: relative; bottom: 0; height: 5%; padding-bottom: 10px; border-radius: 0px 0px 15px 15px;" class="kkselectStyle">
                    <input type="button" class="func_btn" value='<%# GetLangStr("PassCarInfoQuery37","返回目录") %>' onclick="returnKakou()" style="margin-left: 100px;" />

                    <input type="button" class="func_btn" value='<%# GetLangStr("PassCarInfoQuery36","关闭") %>' onclick="hideMenuSelect()" />
                </div>
            </div>
        </div>
        <!-- 显示卡口下拉框结束-->
...
<script type="text/javascript">
    ...
    var start = {
        ...
        choose: function (datas) {
            ...
            PassCarInfoQuery.GetDateTime(true, tt);
    ...
    var end = {
        ...
        choose: function (datas) {
            ...
            var tt = $("#end").html();
            PassCarInfoQuery.GetDateTime(false, tt);
        }
