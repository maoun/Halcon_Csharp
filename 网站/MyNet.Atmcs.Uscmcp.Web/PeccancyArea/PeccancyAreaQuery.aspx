<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PeccancyAreaQuery.aspx.cs"
    Inherits="MyNet.Atmcs.Uscmcp.Web.PeccancyAreaQuery" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:ResourceManager ID="ResourceManager1" runat="server" DirectMethodNamespace="PeccancyAreaQuery" />
        <ext:Hidden ID="GridData" runat="server" />
        <ext:Hidden ID="realCount" runat="server" />
        <ext:Hidden ID="curpage" Style="color: #fb5004; font-weight: bold; padding-left: 10px; padding-right: 10px;" runat="server" />
                            ...
                            <Items>
                                <ext:Toolbar ID="Toolbar1" runat="server">
                                    <Items>
                                        <ext:Panel runat="server">
                                            <Content>
                                                <table style="width: 550px">
                                                    <tr>
                                                        <td style="width: 50px">
                                                            <span class="laydate-span" style="height: 24px; font-size: 15px; margin-left: 6px;">查询时间：</span></td>
                                        ...
                                        <ext:Label ID="Label3" runat="server" Style="margin-left: -130px;" Html="<font >&nbsp;&nbsp;车牌号牌：</font>">
                                        </ext:Label>
                                        <ext:Panel ID="Panel3" runat="server" Height="30" Style="margin-left: -48px;">
                                            <Content>
                                        ...
                                        <ext:Panel runat="server" Layout="ColumnLayout" Height="30">
                                            <Items>
                                                <ext:TextField ID="TxtplateId" runat="server" Width="180" Style="float: left;" EmptyText="六位号牌号码" MaxLength="6">
                                                    <Listeners>
                                                        <Change Fn="change" />
                                                    </Listeners>
                                                </ext:TextField>
                                        ...
                                        <ext:Panel runat="server">
                                            <Items>
                                                <ext:Checkbox ID="ChkLike" Checked="false" runat="server" BoxLabel="模糊查询">
                                                    <DirectEvents>
                                        ...
                                        <ext:Label ID="Label6" runat="server" Style="margin-left: 63px" Html="<font >&nbsp;&nbsp;处理状态：</font>">
                                        </ext:Label>
                                ...
                                <ext:Toolbar ID="Toolbar6" runat="server" Flat="false">
                                    <Items>
                                        ...
                                        <ext:ComboBox ID="CmbEndStation" runat="server" Editable="false" DisplayField="col1"
                                            ...
                                            ListWidth="430" SelectOnFocus="true" Width="365">
                                            <Triggers>
                                                <ext:FieldTrigger Icon="Clear" HideTrigger="true" Qtip="清除选中" />
                                            </Triggers>
                                            <Listeners>
                                ...
                                <ext:Toolbar ID="Toolbar3" runat="server" Flat="false">
                                    <Items>
                                        <ext:Label ID="Label7" runat="server" Html="<font >&nbsp;&nbsp;违法行为：&nbsp;</font>">
                                        </ext:Label>
                                        ...
                                        <%-- <ext:Label ID="Label8" runat="server" Html="<font >&nbsp;&nbsp;查询条数：</font>">
                                        </ext:Label>
                                        <ext:ComboBox ID="CmbQueryNum" runat="server" Editable="false" DisplayField="col1"
                                            Width="75" ValueField="col0" TypeAhead="true" Mode="Local" ForceSelection="true"
                                        ...
                                        <ext:Button ID="TbutQuery" runat="server" Style="margin-left: 450px" Icon="ControlPlayBlue" Text="查询">
                                            <DirectEvents>
                    ...
                    <TopBar>
                        <ext:Toolbar ID="Toolbar2" runat="server" Flat="false">
                            <Items>
                                ...
                                <%--<ext:Label Style="margin-left: 10px" runat="server" ID="titleEnd"></ext:Label>--%>
                            </Items>
                        </ext:Toolbar>
                    </TopBar>
                    <Items>
                        <ext:GridPanel ID="GridPecArea" runat="server" StripeRows="true" Collapsible="true" TrackMouseOver="true"
                            AutoScroll="true" Header="false" Layout="FitLayout">
                            <Store>
                                <ext:Store ID="StorePecArea" runat="server" IgnoreExtraFields="false" OnRefreshData="MyData_Refresh">
                                    ...
                                    <UpdateProxy>
                                        <ext:HttpWriteProxy Method="GET" Url="PeccancyAreaQuery.aspx">
                                        </ext:HttpWriteProxy>
                                    </UpdateProxy>
                                    <Reader>
                                        <ext:JsonReader>
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column Header="传输状态" Width="80" DataIndex="col25" Align="Center">
                                    </ext:Column>
                                </Columns>
                            </ColumnModel>
                            <SelectionModel>
    ...
    <script type="text/javascript">
        ...
        var start = {
            ...
            choose: function (datas) {
                ...
                PeccancyAreaQuery.GetDateTime(true, tt);
            }
        };
        var end = {
            elem: '#end',
            ...
            choose: function (datas) {
                ...
                var tt = $("#end").html();
                PeccancyAreaQuery.GetDateTime(false, tt);
            }
        };
        laydate(start);
        laydate(end);
