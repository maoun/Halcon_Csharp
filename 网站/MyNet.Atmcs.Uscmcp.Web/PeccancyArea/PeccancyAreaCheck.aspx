<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PeccancyAreaCheck.aspx.cs"
    Inherits="MyNet.Atmcs.Uscmcp.Web.PeccancyAreaCheck" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:ResourceManager ID="ResourceManager1" runat="server" DirectMethodNamespace="PeccancyAreaCheck" />
        ...
        <ext:Viewport ID="Viewport2" runat="server" Layout="border">
            <Items>
                            ...
                            <Items>
                                <ext:Toolbar ID="Toolbar1" runat="server">
                                    <Items>
                                        <ext:Panel runat="server" BodyBorder="false" ID="panelTime">
                                            <Content>
                                                <div runat="server" id="selectDate" style="width: 444px">
                                                    <span class="laydate-span" style="margin-left: 5px; height: 24px;">&nbsp;&nbsp;查询时间：</span>
                                        ...
                                        <ext:Label ID="Label3" runat="server" StyleSpec="margin-left: 5px;" Html="<font >&nbsp;&nbsp;车牌号牌：</font>">
                                        </ext:Label>
                                        ...
                                        <ext:Panel runat="server" Layout="ColumnLayout" Height="30">
                                            <Items>
                                                <ext:TextField runat="server" Width="180px" ID="TxtplateId" EmptyText="六位号牌号码" MaxLength="6">
                                                    <Listeners>
                                                        <Change Fn="change" />
                                                    </Listeners>
                                                </ext:TextField>
                                        ...
                                        <ext:Panel runat="server">
                                            <Items>
                                                <ext:Checkbox ID="ChkLike" Checked="false" runat="server" BoxLabel="模糊查询" StyleSpec="margin-left:9px;">
                                                    <DirectEvents>
                                        ...
                                        <ext:Label ID="Label6" runat="server" StyleSpec="margin-left: 42px;" Html="<font >&nbsp;&nbsp;处理状态：</font>">
                                        </ext:Label>
                                ...
                                <ext:Toolbar ID="Toolbar6" runat="server" Flat="false">
                                    <Items>
                                        <ext:Label ID="Label4" runat="server" StyleSpec="margin-left: 5px;" Html="<font >&nbsp;&nbsp;起点卡口：</font>">
                                        </ext:Label>
                                        <ext:ComboBox ID="CmbStartStation" runat="server" Editable="false" DisplayField="col1"
                                            Width="353" ValueField="col0" TypeAhead="true" Mode="Local" ForceSelection="true"
                                            ListWidth="430" EmptyText="选择起点卡口..." SelectOnFocus="true">
                                            <Store>
                                        ...
                                        <ext:Label ID="Label5" runat="server" StyleSpec="margin-left: 9px;" Html="<font >&nbsp;&nbsp;终点卡口：</font>">
                                        </ext:Label>
                                        <ext:ComboBox ID="CmbEndStation" runat="server" Editable="false" DisplayField="col1"
                                            ...
                                            ListWidth="430" SelectOnFocus="true" Width="353">
                                            <Store>
                                ...
                                <ext:Toolbar runat="server">
                                    <Items>
                                        <ext:Label ID="Label7" runat="server" StyleSpec="margin-left: 5px;" Html="<font >&nbsp;&nbsp;违法行为：</font>">
                                        </ext:Label>
                                        <ext:ComboBox ID="CmbPecType" runat="server" Editable="false" DisplayField="col2"
                                            ...
                                            SelectOnFocus="true" Width="353" ListWidth="420">
                                            <Store>
                                        ...
                                        <ext:Label ID="Label8" runat="server" StyleSpec="margin-left: 9px;" Html="<font >&nbsp;&nbsp;提取条数：</font>">
                                        </ext:Label>
                                        ...
                                        <ext:Button ID="TbutQuery" runat="server" Icon="ControlPlayBlue" Text="查询" StyleSpec="margin-left: 300px;">
                                            <DirectEvents>
                ...
                <ext:Panel ID="Panel2" runat="server" Region="Center" DefaultBorder="false" Cls="images-view"
                    Frame="true" Collapsible="false" AutoScroll="true" Layout="FitLayout">
                    <TopBar>
                        <ext:Toolbar ID="Toolbar2" runat="server" Flat="false">
                            <Items>
                                ...
                                <ext:Button ID="ButCheck" runat="server" Icon="TableSave" Style="margin-left: 10px" Text="开始审核">
                                    <DirectEvents>
                    ...
                    <Items>
                        <ext:GridPanel ID="GridPecArea" runat="server" StripeRows="true" Collapsible="true"
                            AutoScroll="true" Header="false" Layout="FitLayout" TrackMouseOver="true">
                            <Store>
                                <ext:Store ID="StorePecArea" runat="server" IgnoreExtraFields="false" OnRefreshData="MyData_Refresh">
                                    ...
                                    <UpdateProxy>
                                        <ext:HttpWriteProxy Method="GET" Url="PeccancyAreaCheck.aspx">
                                        </ext:HttpWriteProxy>
                                    </UpdateProxy>
                                    <Reader>
                                        <ext:JsonReader>
                                            <Fields>
                                                ...
                                                <ext:RecordField Name="col26" Type="Float" />
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column Header="车牌号码" DataIndex="col2" Width="100px" Align="Center">
                                    </ext:Column>
                                    <ext:Column Header="号牌种类" DataIndex="col4" Width="100px" Align="Center">
                                    </ext:Column>
                                    <ext:Column Header="起点卡口" DataIndex="col16">
                                    </ext:Column>
                                    <ext:Column Header="终点卡口" DataIndex="col18" />
                                    <ext:Column Header="驶入驶出时间" DataIndex="col21" Align="Center">
                                    </ext:Column>
                                    <ext:Column Header="路程" DataIndex="col10" Hidden="true" Align="Center">
                                    </ext:Column>
                                    <ext:Column Header="耗时" DataIndex="col12" Hidden="true" Align="Center">
                                    </ext:Column>
                                    <ext:Column Header="速度/限速" DataIndex="col14" Width="80px" Align="Center">
                                    </ext:Column>
                                    <ext:Column Header="超速比例" DataIndex="col26" Width="80px" Align="Center">
                                        <Renderer Fn="pctChange" />
                                    </ext:Column>
                                    <ext:Column Header="违法行为" DataIndex="col9">
                                    </ext:Column>
                                    <ext:Column Header="审核状态" DataIndex="col22" Width="100px" Align="Center">
                                    </ext:Column>
                                </Columns>
                            </ColumnModel>
                            <SelectionModel>
                            ...
                            <Listeners>
                                <%--    <Command Handler="PeccancyAreaCheck.ShowDetails(record.data)" />--%>
                            ...
                            <%-- <Plugins>
                                <ext:RowExpander ID="RowExpander" runat="server">
                                    <Listeners>
                                        <Expand Handler="ShowImg(record.data.col29,record.data.col30);#{Window3}.show();" />
                                        <Collapse Handler="#{Window3}.hide();" />
                                    </Listeners>
                                </ext:RowExpander>
                            </Plugins>--%>
        ...
        <%-- <ext:Window ID="Window3" runat="server" Hidden="true" Height="730px"
            Width="1000px" Title="区间超速车辆图片信息" Resizable="false">
            <Items>
                <ext:BorderLayout runat="server">
                    <Items>
                        <ext:Panel runat="server" StyleSpec="padding:6px;" Height="730" Region="Center">
                            <Content>
                                <div>
                                    <center>
                                        <img alt="图片" title="双击放大图片" src="" id="img1" width="480" ondblclick="OpenBigImg(this.src)"></img>
                                        <img alt="图片" title="双击放大图片" src="" id="img2" width="480" ondblclick="OpenBigImg(this.src)"></img>
                                    </center>
                                </div>
                            </Content>
                        </ext:Panel>
...
<script type="text/javascript">
    ...
    var start = {
        ...
        choose: function (datas) {
            ...
            var tt = $("#start").html();
            PeccancyAreaCheck.GetDateTime(true, tt);
        }
    };
    var end = {
        elem: '#end',
        ...
        choose: function (datas) {
            ...
            var tt = $("#end").html();
            PeccancyAreaCheck.GetDateTime(false, tt);
        }
    };
    laydate(start);
    laydate(end);
