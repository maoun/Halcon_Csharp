 ...
 */
(function ($) {
    var windowMargin = 58; //加多边距的宽高，使得图片看起来有边框效果
    ...
    $.extend({
        ...
        openPhotoGallery: function (obj) {
            ...
            var $gallerys = $(obj).closest(".fis"),
                activeIndex = 0,
                imgs = [];
            $gallerys.find(".photo").each(function (i, elem) {
                var url = this.src,
                    img = $(this)[0],
            ...
            $("<iframe></iframe").appendTo("body")
                .attr("id", "J_pg")
                .attr("src", "../Scripts/Zoom/gallery.html")
                .css({
                    position: "absolute",
        ...
        //打开图片查看器(详情界面)
        openPhotoGalleryXiangqing: function (obj) {
            var $img = $(obj),
                imgUrl = $img[0].src;
            if (!imgUrl) return;
            ...
            var $gallerys = $(obj).closest(".details"),
                activeIndex = 0,
                imgs = [];
            $gallerys.find(".photo").each(function (i, elem) {
                var url = this.src,
        ...
        //图片展示界面
        openPhotoGalleryImg: function (obj) {
            var $img = $(obj),
                imgUrl = $img[0].src;
            if (!imgUrl) return;
            ...
            var $gallerys = $(obj).closest(".thumb"),
                activeIndex = 0,
                imgs = [];
            $gallerys.find(".photo").each(function (i, elem) {
                var url = this.src,
